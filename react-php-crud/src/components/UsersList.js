...
class UsersList extends Component {
    ...
    fetchUsers = () => {
        fetch('http://localhost/phpwithreact/php-react/all-users.php')
            .then(response => {
    ...
    handleUpdate = (id) => {
        Axios.post('http://localhost/phpwithreact/php-react/update-user.php', {
                id: id,
    ...
    handleDelete = (id) => {
        ...
        Axios.post('http://localhost/phpwithreact/php-react/delete-user.php', {
                id: id
            })
            .then(({
                data
